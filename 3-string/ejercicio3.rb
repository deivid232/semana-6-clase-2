...
# 2. La unión de a y b. (hint: Los elementos que se repiten en a y b NO deben
#aparecer repetidos en el resultado).
# 3. La intersección de a y b. (hint: El resultado debe estar compuesto por
#los elementos que se repiten en a y b).
